...
export const bankBalanceField = GovUKTextInput({
  ...
  validWhen: standardMoneyValidWhen(
    'Enter how much was in your partner\'s bank account/building society before your last payment went in, or enter \'0\' if none',
    'How much was in your partner\'s bank account/building society before your last payment went in must only include positive numbers, with or without a decimal point',
  ),
})
...
export const investmentBalanceField = GovUKTextInput({
  ...
  classes: GovUKUtilityClasses.Input.Width10,
  validWhen: standardMoneyValidWhen(
    'Enter the value of any investments, shares or ISAs your partner has, or enter \'0\' if none',
    'The value of any investments, shares or ISAs your partner has must only include positive numbers, with or without a decimal point',
  ),
})
...
export const assetBalanceField = GovUKTextInput({
  ...
  classes: GovUKUtilityClasses.Input.Width10,
  validWhen: standardMoneyValidWhen(
    'Enter the value of any valuable items your partner has worth over £500 each, or enter \'0\' if none',
    'The value of any valuable items your partner has worth over £500 each must only include positive numbers, with or without a decimal point',
  ),
})
...
export const creditBalanceField = GovUKTextInput({
  ...
  classes: GovUKUtilityClasses.Input.Width10,
  validWhen: standardMoneyValidWhen(
    'Enter the amount of any money owed to your partner, or enter \'0\' if none',
    'The amount of any money owed to your partner must only include positive numbers, with or without a decimal point',
  ),
})