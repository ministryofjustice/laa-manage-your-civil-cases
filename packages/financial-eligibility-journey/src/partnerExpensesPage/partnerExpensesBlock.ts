...
const maintenancePaidPartnerConfig: MoneyFieldConfig = {
  ...
  label: 'How much maintenance has your partner paid during the last calendar month?',
...
const legalAidContributionsPartnerConfig: MoneyFieldConfig = {
  ...
  label: 'Is your partner currently paying towards legal aid for criminal defence? If so, how much has your partner paid in the last calendar month?',
