...
export default [
  //  This uses the `@eslint/eslintrc` utility, to translate the eslintrc format that `eslint-config-standard` comes in, so we can use it in this Flat Config format
