...
test('client details selected from opened cases tab has correct page elements', async ({ page, i18nSetup }) => {
  ...
  await assertCaseDetailsHeaderPresent(page, { withMenuButtons: true, expectedName: "Grace Baker", expectedCaseRef: "PC-1869-9154", dateReceived: "8 August 2025 at 1:00am" });  
