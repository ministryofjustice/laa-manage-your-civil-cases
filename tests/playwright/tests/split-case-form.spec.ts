...
test('viewing "split this case" form should display expected elements', async ({ page, pages, i18nSetup }) => {
  ...
  await assertCaseDetailsHeaderPresent(splitCasePage.getPage, { withMenuButtons: false, expectedName: "Jack Youngs", expectedCaseRef: "PC-1922-1879", dateReceived: "7 Jul 2025 at", badgeTexts: ['Urgent', 'At risk of abuse'], dateOfBirth: "18 Aug 1981 (45)" });
