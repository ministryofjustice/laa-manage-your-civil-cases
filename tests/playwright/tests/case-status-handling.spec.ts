...
test.describe('Case Status Handling', () => {
  ...
  test.describe('Accept Case', () => {
    ...
    test('should be able to click Advising and hit endpoint', async ({ page }) => {
      ...
      await clientDetails.navigate();
      // Assert the case details header is present
      await assertCaseDetailsHeaderPresent(page, { withMenuButtons: true, expectedName: "Katie Young", expectedCaseRef: "PC-1922-1866", dateReceived: "7 July 2025 at 1:00am" }); 
    ...
    test('Move a closed case to advising', async ({ page }) => {
      ...
      await clientDetails.navigate();
      // Assert the case details header is present
      await assertCaseDetailsHeaderPresent(page, { withMenuButtons: true, expectedName: "Zechariah Twelve", expectedCaseRef: "PC-4532-2312", dateReceived: "6 January 2025 at 12:00am" }); 
  ...
  test.describe('Close Case', () => {
    test('should submit close case form', async ({ page }) => {
      ...
      // Assert the case details header is present
      await assertCaseDetailsHeaderPresent(page, { withMenuButtons: false, expectedName: "George Allen", expectedCaseRef: "PC-9159-2337", dateReceived: "9 January 2025 at 12:00am" }); 
    ...
    test('should validate required fields', async ({ page }) => {
      ...
      await closePage.navigate();
      // Assert the case details header is present
      await assertCaseDetailsHeaderPresent(page, { withMenuButtons: false, expectedName: "Vinsmoke Sanj", expectedCaseRef: "PC-2211-4466", dateReceived: "8 August 2025 at 1:00am" }); 
   ...
   test.describe('Complete Case', () => {
    test('should be able to click Completed and hit endpoint', async ({ page }) => {
      ...
      await clientDetails.navigate();
      // Assert the case details header is present
      await assertCaseDetailsHeaderPresent(page, { withMenuButtons: true, expectedName: "Ember Hamilton", expectedCaseRef: "PC-3184-5962", dateReceived: "9 January 2025 at 12:00am" }); 
  ...
  test.describe('Reopen Case', () => {
    test('should submit reopen case form', async ({ page }) => {
      ...
      // Assert the case details header is present
      await assertCaseDetailsHeaderPresent(page, { withMenuButtons: false, expectedName: "Red Haired Shanks", expectedCaseRef: "PC-1122-3344", dateReceived: "8 August 2025 at 1:00am" }); 
