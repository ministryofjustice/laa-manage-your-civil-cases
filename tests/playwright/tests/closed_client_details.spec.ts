...
test('client details selected from closed cases tab has correct page elements', async ({ page, i18nSetup }) => {
  ...
  await assertCaseDetailsHeaderPresent(page, { withMenuButtons: true, expectedName: "Roronoa Zoro", expectedCaseRef: "PC-6667-9089", dateReceived: "6 Jan 2025 at", badgeTexts: ['At risk of abuse', 'Third Party'] });
