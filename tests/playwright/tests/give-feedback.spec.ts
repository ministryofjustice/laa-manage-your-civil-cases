...
test('viewing "do you want to give feedback" form should display expected elements', async ({ page, i18nSetup }) => {
  ...
  await assertCaseDetailsHeaderPresent(feedbackPage.getPage, { withMenuButtons: false, expectedName: "Roronoa Zoro", expectedCaseRef: "PC-6667-9089", dateReceived: "6 Jan 2025 at", badgeTexts: ['At risk of abuse', 'Third Party'] }); 
