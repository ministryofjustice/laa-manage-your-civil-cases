...
const pagesToCheck = [
  'cases/new',
  'cases/completed',
  'cases,PC-1922-1879/client-details',
  'cases,PC-1922-1879/give-operator-feedback',
  'cases,PC-1922-1879/cookies',
  'cases,PC-1922-1879/help',
  'cases/VT-3349-1236/financial-eligibility/change/under-18',
  'search',
];

for (const url of pagesToCheck) {
  test(`feedback component switches sections and resets on cancel for ${url}`, async ({ page }) => {
    await page.goto(`/$url)`);
