/**
 * Case Viewer Socket Client Middleware
 * Manages real-time notifications for case viewing status, which shows MOJ Alert when other users are viewing the same case.
 */

import { devLog, devWarn, devError } from '../scripts/helpers/devLogger.js';
import type { Socket, ViewersUpdatedData, WindowWithIO } from '#types/socket-io-types.js';
