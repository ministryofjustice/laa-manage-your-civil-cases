...
/**
 * Validation middleware for reopen case form.
 * @returns {Error} Validation schema for express-validator
 */
export const validateReopenCase = (): ReturnType<typeof checkSchema> =>
  checkSchema(reopenCaseSchema);
