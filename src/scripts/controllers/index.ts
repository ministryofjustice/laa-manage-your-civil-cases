/**
 * Index for controllers GET & POST routes
 *
 * Usage:
 * import { getEditClientName, postEditClientName } from '#src/scripts/controllers/index.js';
 */
...
export * from './getLegalHelpFormController.js';
